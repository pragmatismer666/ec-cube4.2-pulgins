...
class RecurringService{
            ...
            if($order){
                if (!$this->hasOverlappedPaidOrder($rec_order)) {
                    ...
                    $this->dispatcher->dispatch(
                        ...
                        StripeRecEvent::REC_ORDER_SUBSCRIPTION_PAID
                    );
                }
    ...
    public function invoiceUpcoming($object){
        ...
        $upcoming_mail = $this->config_service->get(ConfigService::INCOMING_MAIL) ? true : false;
    ...
    public function cancelRecurring($rec_order){
        ...
        if($rec_order->isScheduled()){
            $state = $this->pb_service->getScheduleState($rec_order);
...
// OrderStatus
        ...
        $this->dispatcher->dispatch($event, StripeRecEvent::NEW_CHARGE_ORDER_COPIED);
