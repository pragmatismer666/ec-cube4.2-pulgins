...
class CartLimitController extends CartController
{
    ...
    public function __construct(
        ...
        // $loader = new YamlFileLoader($container, new FileLocator(dirname(__DIR__).DIRECTORY_SEPARATOR.'Resource'.DIRECTORY_SEPARATOR.'config' ) );
        // $loader->load('config_service.yaml');
        // $this->config_service = $container->get('plg_stripe_rec.service.admin.plugin.config', ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE);
    }

    /*
        temporary function instead of config_service
        Must be reimplemented with config_service
    */
    private function isMultiProduct(){
    ...
    public function addCart(Request $request, Product $Product)
    {
        ...
        $is_multi_product = $this->isMultiProduct();
        if (!$is_multi_product) {
